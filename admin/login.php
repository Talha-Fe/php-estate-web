...
<head>
    ...
    <title>Admin Giriş - Melek Demir Gayrimenkul</title>
...
<div class="admin-login-wrap">
    <div class="admin-login-card">
        <div class="admin-login-brand">
            <img class="admin-login-badge" src="../logo.png" alt="Melek Demir Gayrimenkul logo">
            <h1>Yönetim Paneli</h1>
            <p>Melek Demir Gayrimenkul yönetim ekranına giriş yapın.</p>
        </div>
