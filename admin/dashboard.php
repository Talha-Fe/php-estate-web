...
<head>
    ...
    <title>Admin Paneli - Melek Demir Gayrimenkul</title>
...
<div class="admin-shell">
    <aside class="admin-sidebar">
        ...
        <nav class="admin-sidebar-nav">
            ...
            <a href="contact-messages.php">İletişim Mesajları</a>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            <?php foreach ($properties as $property): ?>
                                <?php
                                $thumbStmt->execute(['property_id' => $property['id']]);
                                    ...
                                    <td>
                                        <div class="admin-property-cell">
                                            <div class="admin-property-thumb">
                                                <?php if ($thumb): ?>
                                                    <img src="../uploads/<?php echo htmlspecialchars($thumb['image_name']); ?>" alt="<?php echo htmlspecialchars($property['title']); ?>">
                                                <?php else: ?>
